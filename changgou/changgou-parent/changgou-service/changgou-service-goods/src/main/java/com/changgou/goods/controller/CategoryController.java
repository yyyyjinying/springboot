...
public class CategoryController {
    ...
    public Result<List<Category>> selByPid(@PathVariable Integer id){
        List<Category> categories = categoryService.selByPid(id);
        return new Result<List<Category>>(true, StatusCode.OK, "查询成功",categories);
    }

    @GetMapping(value="/pid/{pid}")
    public Result<List<Category>> selectByPid(@PathVariable Integer pid){
