...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public List<Category> selByPid(Integer id) {
        return categoryMapper.selByPid(id);
    }

    @Override
    public List<Category> selectByPid(Integer id) {
        return categoryMapper.selectByPid(id);
    }
}
